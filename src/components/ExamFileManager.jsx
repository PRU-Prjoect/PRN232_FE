        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6">
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Upload ZIP files containing student submissions for {courseInfo.code}
                </p>
              </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <ul className="mt-2 text-sm text-orange-700 list-disc pl-5 space-y-2">
                        <li>Upload a ZIP file containing exam materials for {courseInfo.code}</li>
          ...
          {activeTab === 'grades' && (
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Grading Coming Soon</h3>
